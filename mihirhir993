...
def qLearning(n, p, p1, encoder, ENClast):
    ...
    while qError(Q, Qlast) > 1.5 or Q == Qlast or iteration <= 8:  # check for the error value to be 10**-3 or Q = Qlast
	...
	print ("list = "), list
        for i in range(0, 20):
            ...
            if i in list:
                ...
                if raw == 0 and action == 0:
                    action = 1
                elif raw == size[0]-1 and action == 1:
                    action = 0
                elif col == 0 and action == 2:
                    action = 3
                elif col == size[1]-1 and action == 3:
                    action = 2
